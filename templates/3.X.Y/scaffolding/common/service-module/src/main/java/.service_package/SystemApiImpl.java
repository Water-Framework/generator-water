...
import it.water.repository.service.<%-persistenceLib%>.EntitySystemServiceImpl;
 ...
 */
@FrameworkComponent
public class <%- projectSuffixUpperCase %>SystemServiceImpl extends EntitySystemServiceImpl< <%- projectSuffixUpperCase %>> implements <%- projectSuffixUpperCase %>SystemApi {
