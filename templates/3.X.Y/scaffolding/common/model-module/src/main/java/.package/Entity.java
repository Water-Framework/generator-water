 ...
 if(isProtectedEntity || isOwnedEntity){
   ...
   if(isProtectedEntity){
        defineActionsAndRolesAnnotation = ''+
            ...
            '        @DefaultRoleAccess(roleName = '+modelName+'.DEFAULT_MANAGER_ROLE, actions = {CrudActions.SAVE, CrudActions.UPDATE, CrudActions.FIND,CrudActions.FIND_ALL, CrudActions.REMOVE}),\n'+
            '        //Viwer has read only access\n'+
            '        @DefaultRoleAccess(roleName = '+modelName+'.DEFAULT_VIEWER_ROLE, actions = {CrudActions.FIND,CrudActions.FIND_ALL}),\n'+
            '        //Editor can do anything but remove\n'+
            '        @DefaultRoleAccess(roleName = '+modelName+'.DEFAULT_EDITOR_ROLE, actions = {CrudActions.SAVE, CrudActions.UPDATE, CrudActions.FIND,CrudActions.FIND_ALL})\n'+
            '})';
...
<%if (isProtectedEntity){ -%>
    public static final String DEFAULT_MANAGER_ROLE = "<%- modelName %>Manager";
    public static final String DEFAULT_VIEWER_ROLE = "<%- modelName %>Viewer";
    public static final String DEFAULT_EDITOR_ROLE = "<%- modelName %>Editor";
<% } -%>
    //insert fields...
